<form>
    ...
    <!--Question 3-->
    What ZIP code does CSUMB have? 
    <input type="text" name="question3" size="5" /><br />
    <div id="question3-feedback" class="answer"></div><br />
    
    <!--Question 4-->
    What city is CSUMB in?<br />
    <input type="radio" name="question4" id="q4-1"  value="A"/><label for='q4-1'>Monterey Bay<br />
    <input type="radio" name="question4" id="q4-2"  value="B"/><label for='q4-2'>Seaside<br />
    <input type="radio" name="question4" id="q4-3"  Value="C"/><label for='q4-3'>Santa Cruz<br />
